...
![Install VS Code from MS Store](graphics/vs_code_clone_make_changes_push/1_install_vscode_from_msstore.jpg)
...
![Sign in using GitHub](graphics/vs_code_clone_make_changes_push/2_sign_in_using_github.png)

Alternatively, click the **Accounts** icon in the bottom-left corner of VS Code and select **Sign in with GitHub**.

![Sign in — second option](graphics/vs_code_clone_make_changes_push/2.1._sign_in_second_option.png)

---

## 3) Sign in with your VUT email

![Sign in with VUT email](graphics/vs_code_clone_make_changes_push/3_sign_in_wiht%20your_VUT_email.png)
...
![Confirm to synchronize](graphics/vs_code_clone_make_changes_push/4_confirm_to_synchronize.png)

---

## 5) Clone the repository

![Clone repository](graphics/vs_code_clone_make_changes_push/5_clone_repository.png)
...
![Select repo destination](graphics/vs_code_clone_make_changes_push/6_select_repo_destination.png)

---

## 7) Change to your working branch

![Change to working branch](graphics/vs_code_clone_make_changes_push/7_change_on_working_branch.png)
...
![Install Git Graph extension](graphics/vs_code_clone_make_changes_push/8_install_gitgraph_extension.png)
...
![Update README](graphics/vs_code_clone_make_changes_push/9_update_readme.png)
...
![Commit through Source Control](graphics/vs_code_clone_make_changes_push/10_commit_htru_source_control.png)
...
![Push to remote](graphics/vs_code_clone_make_changes_push/11_push_to_remote_all_cahnges.png)
